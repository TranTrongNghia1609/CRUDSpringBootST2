package vn.iotstar.CRUD_springboot3.controllers;
...
import vn.iotstar.CRUD_springboot3.service.imp.CategoryService;
...
public class CategoryController {
    ...
    public String search (ModelMap model,@RequestParam(name="categoryname", required = false) String name,
        ...
        if(StringUtils.hasText(name)) {
            resultPage = categoryService.findByCategoryname(name, pageable);
